             ...
             <div class="bg-white p-10 flex flex-col w-full shadow-xl rounded-xl">
               ...
               <form action="" class="w-full">
                 ...
                 <div id="button" class="flex flex-col w-full my-5">
                   ...
                   >
                     <div @click="MailchangeHandler()" class="flex flex-row items-center justify-center">
                       <div class="mr-2">
                         <svg
                           class="w-6 h-6"
                           fill="none"
                       ...
                       <div class="font-bold">Send Request</div>
                     </div>
                   </button>
                 </div>
               </form>
...
export default {
   ...
   methods: {
      async MailchangeHandler() {
         const data = {
            old_email: this.old_email,
            new_email: this.new_email
         };
         try {
            const res = await this.$axios.post("http://10.10.6.87/pmp/api/user/change-mail/", data)
