		        ...
		        <div v-for="(element, index) in params.config">
				    ...
				    <div class="flex justify-left">
					  <div class="mb-3 mt-2 xl:w-full">
				    	<label class="block text-sm font-medium text-gray-900 dark:text-gray-300">Datatype</label>
					    <select v-model="element['data_type']" class="form-select
					      ...
					      focus:text-gray-700 focus:bg-white focus:border-gray-600 focus:outline-none" aria-label="Default select example">
					        ...
					        <option value="character1" id="radio">Radio</option>
					...
					<div v-if="((element['data_type']=='multiradio') || (element['data_type']=='character1'))">
						...
						<button v-if="((element['data_type']=='multiradio') || (element['data_type']=='character1'))" class="text-white bg-gray-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @click="onOptions(element)" type="button">Add</button>
			        </div>

				    <div>
				    	<label class="block text-sm font-medium text-gray-900 dark:text-gray-300">Maximum length</label>
				    ...
				    <div class="flex justify-left">
					  <div class="mb-3 mt-2 xl:w-full">
				    	<label class="block text-sm font-medium text-gray-900 dark:text-gray-300">Null field</label>
				    ...
				    <div class="flex justify-left">
					  <div class="mb-3 xl:w-full">
				    	<label class="block text-sm font-medium text-gray-900 dark:text-gray-300">Unique</label>
...
<script type="text/javascript">
	export default {
		...
		methods: {
			...
			async createSampleIdentifier() {
				this.params.config.forEach(function(e,i) {
					let ol = []
					if (e.data_type == "character1") {
						e.data_type = "character"
					}
				...
				this.$store.dispatch("base/CreateSampleIdentifier", this.params);
			},
		}
	}
</script> -->