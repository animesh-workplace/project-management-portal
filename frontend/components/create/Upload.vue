	...
	export default {
		...
		methods: {
			async getProjectConfig() {
				// let d = await d3.tsv("/home/nsm-07/Downloads/lineage_substitution_deletion_report (3).tsv");
    // 			console.log(d);
				this.metadata = false
				this.metadataColor = ""
		...
		mounted() {
	    	this.$nextTick(() => {
	    // 		d3.csv('/home/nsm-07/Downloads/lineage_substitution_deletion_report (3).tsv', (myData) => {
